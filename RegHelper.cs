...
namespace ViPER4WindowsBin
{
    internal class RegHelper
    {
        ...
        public static bool CheckConfigRegister()
        {
            ...
            int num2 = QueryRegistryStringValue("SOFTWARE\\ViPER4Windows", "ConfigPath", num1, nBufferSize);
            Marshal.Copy(num1, destination1, 0, nBufferSize * 2);
            int num3 = QueryRegistryStringValue("SOFTWARE\\ViPER4Windows", "ConfigFile", num1, nBufferSize);
            ...
            Array.Copy(charArray1, destinationArray1, length1);
            ...
            Array.Copy(charArray2, destinationArray2, length2);
        ...
        public static string GetConfigFile()
        {
            ...
            char[] destination = new char[nBufferSize * 2];
            IntPtr num1 = Marshal.AllocHGlobal(nBufferSize * 2);
            int num2 = QueryRegistryStringValue("SOFTWARE\\ViPER4Windows", "ConfigFile", num1, nBufferSize);
            Marshal.Copy(num1, destination, 0, nBufferSize * 2);
            Marshal.FreeHGlobal(num1);
            if (num2 == 0)
                return "";
        ...
        public static uint QueryDWORD(string szKeyName, uint uiDefault)
        {
            ...
            int num2 = QueryRegistryDWORDValue("SOFTWARE\\ViPER4Windows", szKeyName, num1);
        ...
        public static bool WriteDWORD(string szKeyName, uint uiValue)
        {
            ...
            return WriteRegistryDWORDValue("SOFTWARE\\ViPER4Windows", szKeyName, uiValue1) != 0;
        }
    }
}
